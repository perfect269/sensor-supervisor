				...
				case Sensor.TYPE_ORIENTATION:
					...
					holder.sensorListener = new SensorEventListener() {
						...
						public void onSensorChanged(SensorEvent event) {
						    ...
						    if(SAVE_LOCATION.equals("Don't Save")){
						    	//Toast.makeText(getActivity().getApplicationContext(), mFileHelper.write("sensordata","kaydedilmiyor") + "", Toast.LENGTH_SHORT).show();
						    	
						    }else if (SAVE_LOCATION.equals("Database")) {
